    ...
    <div class="container bg-grey" id="contact">
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <p><span class="glyphicon glyphicon-map-marker"></span> Group6 Students ICTU, LVL4</p>
                <p><span class="glyphicon glyphicon-phone"></span> +237 676548087</p>
...
<script>
    var myCenter = new google.maps.LatLng(3.848000,11.502100);
